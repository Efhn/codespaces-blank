...
rad_level = INVALID # initialize it to zero
...
unit = input("Enter 'W' for Wavelength, or 'F' for Frequency")
if unit == 'F':
    ...
    print('Support for Wavelength coming soon!')
else:
    print('Unsupported unit')
print(f'Based on your input, your frequency is: {RADIATION_TYPES[rad_level]}')
